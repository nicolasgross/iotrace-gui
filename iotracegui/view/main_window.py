...
class MainWindow (QMainWindow, Ui_MainWindow):
    ...
    def _menuHelpAbout(self):
        QMessageBox.about(self, "About", "<h3 align=center>iotrace-GUI</h3>" +
                "<p align=center>iotrace-GUI is a tool for displaying the " +
                "traces generated by iotrace. These traces contain " +
                "information about the I/O behavior of the traced program. " +
                "Besides displaying the traces, the tool is also able to " +
                "merge traces.</p>" +
                "<p align=center>" +
